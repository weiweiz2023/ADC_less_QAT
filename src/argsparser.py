...
def get_parser():
    ...
    parser.add_argument('--run-info', default='test', type=str,
    ...
    parser.add_argument('--resume', type=str, default='/home/weiweiz/Documents/WW_03/saved/models/_resnet20_CIFAR10_20_128_0p001_pruning_0_1_True_0_1_False_1_False_0p0001_False.th')
    ...
    parser.add_argument('--adc_reg_lambda', type=float, default=0.0001,
    ...
    parser.add_argument('--conv_prune_rate', default=0.5, type=float,
                        help='Set prune rate for')
    parser.add_argument('--linear_prune_rate', default=0.5, type=float,
                        help='Set prune rate for')
    parser.add_argument('--input_prune_rate', default=0.4, type=float,
                        help='Set prune rate for')
...
# Calibration parameters (add after existing ADC params)
    ...
    ## VQ Parameters 
    ##################################################################################################################
    parser.add_argument('--use-vq', dest='use_vq', action='store_true', default=True,
                        help='Use Vector Quantization before bit slicing')
    parser.add_argument('--vq-commitment-cost',dest='commitment_cost', default=0.05, type=float,
                        help='Commitment cost for VQ loss (default: 0.25)')
    parser.add_argument('--vq-loss-weight', default=0.01, type=float,
                        help='Weight for VQ loss in total loss (default: 0.1)')
